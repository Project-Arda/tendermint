...
func TestGenesis(t *testing.T) {
	...
	baseGenDoc := &GenesisDoc{
		ChainID:    "abc",
		Validators: []GenesisValidator{{crypto.GenPrivKeyAltbn128().PubKey(), 10, "myval"}},
	}
	genDocBytes, err := json.Marshal(baseGenDoc) //FIXME altbn128 pubkey isn't json marshaling
